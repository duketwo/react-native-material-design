...
import {PropTypes, Text, View, Animated } from 'react-native';
                ...
                <View>
                    ...
                    >
                        <View style={{ flex: 1, justifyContent: 'center' }}>
                            <Text style={[styles.badgeText, { color: getColor(badge.textColor), backgroundColor: 'transparent' }, badge.value > 99 ? { fontSize: 8 } : { fontSize: 10 }]}>
                                {badge.value}
                            </Text>
                        </View>
                    </Animated.View>
