...
import {PropTypes, View, Text, TouchableNativeFeedback } from 'react-native';
import Icon from '../Icon';
import Ripple from '../polyfill/Ripple';
import { TYPO } from '../config';
import { isCompatible, isAndroid, isIOS } from '../helpers';
        ...
        return (
            ...
            >
                ...
                <View style={styles.value}>
                    <Text style={[TYPO.paperFontBody2, { color }, {backgroundColor: 'transparent'}]}>
                        {item.value}
                    </Text>
                </View>
                {item.label &&
        ...
        return (
            <View style={styles.section}>
                ...
                <View style={[styles.subheader, styles.item]}>
                    <Text style={[TYPO.paperFontBody2, { color: SUB_TEXT_COLOR, backgroundColor: 'transparent' }]}>
                        {title}
                    </Text>
                </View>
                }
