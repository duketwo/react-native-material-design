...
import {PropTypes, View, TouchableNativeFeedback } from 'react-native';
import Ripple from '../polyfill/Ripple';
import { getColor, isCompatible, isAndroid, isIOS } from '../helpers';
    ...
    render() {
        ...
        const cardStyle = (() => {
            return [
                ...
                }, style, (!isCompatible('elevation') || isIOS())  && {
                    borderWidth: 1,
